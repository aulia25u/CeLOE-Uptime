...
requests for CeLOE Uptime. I never thought the GitHub community would be so nice!
...
## Can I Create a Pull Request for CeLOE Uptime?
...
- Make sure the **UI/UX is close to CeLOE Uptime**.
...
you can finally start the app. The goal is to make the CeLOE Uptime installation
...
CeLOE Uptime Frontend is a single page application (SPA). Most paths are handled
by Vue Router.
...
If you want to help by translating CeLOE Uptime into your language, please visit
...
- `2.x.x-beta.x`
- `nightly2`: Dev build
- `base2`: Basic Debian setup without CeLOE Uptime source code (Full features)
- `base2-slim`: Basic Debian setup without CeLOE Uptime source code
...
- `nightly`: Dev build
- `base-debian`: Basic Debian setup without CeLOE Uptime source code
- `pr-test`: For testing pull request without setting up a local environment
- `base-alpine`: (Deprecated) Basic Alpine setup without CeLOE Uptime source code
